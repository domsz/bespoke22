  ...
  return (
    <span
      ...
      className={clsx([
        ...
        'dark:before:hidden',
        // Focus ring
        'after:pointer-events-none after:absolute after:inset-0 after:ring-transparent after:ring-inset sm:focus-within:after:ring-2 sm:focus-within:after:ring-zinc-900',
        // Disabled state
    ...
    >
      <Headless.Textarea
        ...
        className={clsx([
          // Basic layout
          'relative block h-full w-full appearance-none px-[calc(--spacing(3.5)-1px)] py-[calc(--spacing(2.5)-1px)]',
          // Typography
