      ...
      <div className="mx-auto max-w-screen-2xl px-6 pb-8 pt-16">
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
                ...
                <ul role="list" className="mt-6 space-y-4">
                  {navigation.menu.map((item) => (
                    <li key={item.name}>
                      <a
                        href={item.href}
                        className="text-md text-zinc-400 hover:text-white"
                      >
                        {item.name}
                      </a>
                    </li>
              ...
              <div className="mt-10 md:mt-0">
                ...
                <ul role="list" className="mt-6 space-y-4">
                  <li className="text-md text-zinc-400">
                    Address?
                  </li>
                  <li className="text-md text-zinc-400">
                    info@bespoke22.com
                ...
                <ul role="list" className="mt-6 space-y-4">
                  {navigation.social.map((item) => (
                    <li key={item.name}>
                      <a
                        href={item.href}
                        className="flex text-md text-zinc-400 hover:text-white"
                      >
                        <item.icon aria-hidden="true" className="size-6 mr-2" />
                        <span>{item.name}</span>
                      </a>
                    </li>
                  ))}
        ...
        <div className="mt-8 border-t border-zinc-800 pt-8">
          <p className="text-sm/6 text-zinc-500">
            &copy; 2025 B22 London — all rights reserved.
          </p>
        </div>
      </div>
    </footer>
